...
(function (root) {
  ...
  B.effect = {
    dmg: l => `${B.base.dps + 4 * l} dmg/s`,
    air: l => `${B.base.air + 1.5 * l} s`,
    size: l => `${B.base.radius + 5 * l} px`,
    value: l => `×${(1 + 0.25 * l).toFixed(2)}`,
    fins: l => `${(B.base.fins + 0.35 * l).toFixed(2)} m/s`,
    bubble: l => `+${(B.base.bubble + 0.3 * l).toFixed(1)} s`,
    suit: l => `−${(B.base.sting * (1 - 0.2 * l)).toFixed(1)} s`,
    tank2: l => `+${3 * l} s`,
    shock: l => `${15 * l}%`,
    sonar: l => `${50 * l}%`,
    drone: l => `${20 * l}%`,
